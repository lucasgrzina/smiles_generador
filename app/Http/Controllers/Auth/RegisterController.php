    ...
    */
    ...
    public function register(Request $request)
    {
        ...
        try {
            ...
            return response()->json(ResponseUtil::makeError($e->getMessage(), [], 500));
        }
    ...
    protected function validator(array $data)
    {
        ...
        $messages = [
            ...
            'password.regex' => 'El Password debe contener mayúsculas y minúsculas, también un número al menos.'
        ];
