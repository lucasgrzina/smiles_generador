...
@section('content-header')
    {!! AdminHelper::contentHeader('Contenido Predefinido',isset($data['selectedItem']->id) && $data['selectedItem']->id > 0 ? trans('admin.edit') : trans('admin.add_new'),false) !!}
@endsection
...
@section('content')
    ...
    <div class="content">
        <div class="box box-default box-cu">
            <div class="box-body">
                <div class="row">
                        @include('admin.contenido_predefinidos.fields')
                </div>
            </div>
