...
<html>
	<head>
		...
		<style type="text/css">
			...
			.applelinkFooter a{color:#7c7c7c; text-decoration:none;}
							...
							<td style="text-align:center; font-size:0;">
								<div style="display:inline-block; vertical-align:top;">
									<table align="center" width="600" cellspacing="0" cellpadding="0" border="0">
										...
										<tr>
											<td height="10" style="font-size:0px; height:10px; line-height: 0px">&nbsp;</td>
											<td align="left" width="276" class="full-width" style="font-family: Arial, Helvetica, sans-serif; color: #828484; font-size: 11px; text-align: LEFT;"> @if($publicidad)PUBLICIDAD @endif</td>
											<td align="center" width="279" class="full-width" style="font-family: Arial, Helvetica, sans-serif; color: #828484; font-size: 11px; text-align: right;">
												<a href="$prefilledform(campaignname())$" target="_blank" style="color: #868a8d;">VER EN EL NAVEGADOR</a>.
											</td>
											<td height="10" style="font-size:0px; height:10px; line-height: 0px">&nbsp;</td>
										</tr>
								...
								<td valign="top" width="600" height="84" style="padding:0;width:600px;height:84px;border-bottom:2px solid rgb(236,236,236)">
									<table cellspacing="0" cellpadding="0" align="center">
										<tr>
											...
											<td width="131" height="84" bgcolor="#ffffff" style="padding:0;width:131px;height:auto; bac"><img class=" full-width" src="https://smiles-mkt-ar.s3.amazonaws.com/logo-header.png" border="0" alt="Smiles" style="display:block;margin:auto">
											</td>
											<td valign="top" width="423" height="84" style="color:rgb(240,240,240);background:rgb(255,255,255);font-family:arial;font-size:13px;line-height:15px;mso-line-height-rule:exactly;text-align:right;width:423px;height:84px">
												...
												@if($saldo)
												<br />
												<span style="color:#828484;font-size:11px"> Saldo: <b>$cond(eq(1, empty(lookup(DT_PROCESS_SALDO))),nothing (),lookup(DT_PROCESS_SALDO))$: </b> <span style="color:#4599e4;;font-weight:bold"> $cond(eq(1, empty(lookup(Saldo_Pontos))), nothing(), numberformat(lookup(Saldo_Pontos),1.0f,1,0,de))$ </span>

												</span>
												@endif
											<br>

											<a href="https://www.smiles.com.ar/login/?utm_source=newsletter&utm_medium=email&utm_campaign=transferencia_17072020&utm_content=header-micuenta" style="color: #828484; font-family: Tahoma, Arial, Helvetica, sans-serif; font-size: 11px; line-height: 13px;" target="_blank" rilt="Conta_Smiles">Entrar a mi cuenta</a>

										</td>

										<td valign="top" width="19" height="84" style="padding:0;width:19px;height:84px;background:rgb(255,255,255)">
										</td>
									</tr>
								</table>
							</td>
