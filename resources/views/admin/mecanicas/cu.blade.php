...
@section('content-header')
    {!! AdminHelper::contentHeader('Mecanicas',isset($data['selectedItem']->id) && $data['selectedItem']->id > 0 ? trans('admin.edit') : trans('admin.add_new'),false) !!}
@endsection
...
@section('content')
    ...
    <div class="content">
        <div class="box box-default box-cu">
            <div class="box-body">
                <div class="row">
                        @include('admin.mecanicas.fields')
                </div>
            </div>
