...
@section('content-header')
    {!! AdminHelper::contentHeader('Noticias',isset($data['selectedItem']->id) && $data['selectedItem']->id > 0 ? trans('admin.edit') : trans('admin.add_new'),false) !!}
@endsection
