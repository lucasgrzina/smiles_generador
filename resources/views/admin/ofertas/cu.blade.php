...
@section('content-header')
    {!! AdminHelper::contentHeader('Ofertas',isset($data['selectedItem']->id) && $data['selectedItem']->id > 0 ? trans('admin.edit') : trans('admin.add_new'),false) !!}
@endsection
