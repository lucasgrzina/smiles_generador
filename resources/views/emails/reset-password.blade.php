...
<html lang="es">
  ...
  <body class="text-center">
    ...
    <div class="container">
      ...
      <h1 class="h1 mb-3 font-weight-normal">Te generamos una nueva clave</h1>
      <p class="p mb-3 font-weight-normal">Hola {{$user->nombre}}, tu nueva clave es {{$clave}}.<br></p>

      <a href="{{route('home')}}" class="link-001" target="_self"><div class="btn btn-lg btn-002 btn-block">Ingresá a tu cuenta.</div></a>
